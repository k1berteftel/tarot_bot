...
user_dialog = Dialog(
    Window(
        DynamicMedia('media'),
        Const('<b>Добро пожаловать 🌙</b>\n\nЯ твоя личная ведьма-таролог 🔮\nПомогу разобраться в ситуации '
              'с помощью карт Таро — посмотрим <b>чувства, отношения, деньги и то, что пока остаётся скрытым ✨</b>'
              '\n\nТакже могу провести <b>ритуал, вернуть бывшего или сделать привязку к нынешнему партнёру ❤️</b>'),
        Column(
